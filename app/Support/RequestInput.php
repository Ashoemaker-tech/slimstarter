...
class RequestInput
{
    ...
    public function forget(array $properties)
    {
        // Go ahead and forget the csrf tokens to avoid writing in controllers.
        if (isset($this->attributes['csrf_name']) && isset($this->attributes['csrf_value'])) {
            unset($this->attributes['csrf_name']);
            unset($this->attributes['csrf_value']);
        }
